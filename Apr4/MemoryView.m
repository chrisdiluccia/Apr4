...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CGRect fr1 = CGRectMake(210, h-375, 100, 100);
        ...
        CGRect fr2 = CGRectMake(10, h-275, 100, 100);
        ...
        CGRect la1 = CGRectMake(110, h-375, 100, 100);
        ...
        CGRect la2 = CGRectMake(210, h-175, 100, 100);
        ...
        CGRect hi1 = CGRectMake(10, h-175, 100, 100);
        ...
        CGRect hi2 = CGRectMake(210, h-275, 100, 100);
        ...
        CGRect dy1 = CGRectMake(10, h-375, 100, 100);
        ...
        CGRect dy2 = CGRectMake(110, h-175, 100, 100);
        ...
        CGRect ap = CGRectMake(110, h-275, 100, 100);
...
- (void) touchesEnded: (NSSet *) touches withEvent: (UIEvent *) event {
    ...
    if ((point.x >= 210) && (point.x <=310) && (point.y >=h-325) && (point.y <= h-225))
    {
    ...
    else if ((point.x >= 10 && point.x <=110) && (point.y >=h-225) && (point.y <= h-125))
    {
    ...
    else if ((point.x >= 110) && (point.x <= 210) && (point.y >=h-325) && (point.y <= h-225))
    {
    ...
    else if ((point.x >= 210) && (point.x <=310) && (point.y >=h-125) && (point.y <= h-25))
    {
    ...
    else if ((point.x >= 10) && (point.x <=110) && (point.y >=h-125) && (point.y <= h-25))
    {
    ...
    else if ((point.x >= 210) && (point.x <=310) && (point.y >=h-225) && (point.y <= h-125))
    {
    ...
    else if ((point.x >= 10) && (point.x <=110) && (point.y >=h-325) && (point.y <= h-225))
    {
    ...
    else if ((point.x >= 110) && (point.x <= 210) && (point.y >= h-125) && (point.y <= h-25))
    {
